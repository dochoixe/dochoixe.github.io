(function initDiscCatalog(){
  ...
  const configuredPrice=(id,fallback)=>{const value=(config.PRODUCT_PRICES||{})[id];const number=Number(value);return Number.isFinite(number)&&number>0?number:fallback};
  const products=[
    {id:"rcb-rs-267",brand:"RCB",type:"floating",size:"267",bike:"LC135 5S 125ZR",name:"RCB RS Series Floating 267mm",code:"01D0532B",image:"assets/images/rcb-rs-floating.webp",price:configuredPrice("rcb-rs-267",1790000),note:"Tâm nhôm 7-series T6; LC135 4S/LCV8 có cấu hình cần pat.",detail:"rcb-rs-series-floating.html",source:"Giá cố định trên website"},
    {id:"rcb-rs-298",brand:"RCB",type:"floating",size:"298",bike:"Y15ZR Y16ZR",name:"RCB RS Series Floating 298mm",code:"01D0545",image:"assets/images/rcb-rs-floating.webp",price:configuredPrice("rcb-rs-298",1990000),note:"Bản floating lớn cho Y15ZR/Y16ZR; kiểm tra mâm, pat và heo.",detail:"rcb-rs-series-floating.html",source:"Giá cố định trên website"},
    {id:"rcb-exciter-front-245",brand:"RCB",type:"fixed",size:"245",bike:"Exciter 150 Exciter 155",name:"RCB đĩa trước Exciter 150/155 245mm",code:"Mã theo phiên bản",image:"assets/images/rcb-e2-steel.webp",price:configuredPrice("rcb-exciter-front-245",460000),note:"Cấu hình trước 245mm; cần xác nhận lỗ bắt và đời xe trước khi giao.",source:"Giá cố định trên website"},
    {id:"rcb-exciter-rear-203",brand:"RCB",type:"fixed",size:"203",bike:"Exciter 150 Exciter 155",name:"RCB đĩa sau Exciter 150/155 203mm",code:"Mã theo phiên bản",image:"assets/images/rcb-e2-steel.webp",price:configuredPrice("rcb-exciter-rear-203",90000),note:"Đĩa sau 203mm; ngoại hình được xác nhận theo lô hàng.",source:"Giá cố định trên website"},
    {id:"rcb-e2-190",brand:"RCB",type:"fixed",size:"190",bike:"Vario 150 Click 150 Beat",name:"RCB E2 Series Steel 190mm",code:"Dòng 01D0525Z",image:"assets/images/rcb-e2-steel.webp",price:configuredPrice("rcb-e2-190",350000),note:"Có mã cho Vario/Click/Beat; vị trí và số lỗ thay đổi theo mã.",source:"Giá shop cố định"},
    {id:"rcb-e2-220",brand:"RCB",type:"fixed",size:"220",bike:"Vario 160",name:"RCB E2 Series Steel 220mm",code:"Dòng 01D0525Z",image:"assets/images/rcb-e2-steel.webp",price:configuredPrice("rcb-e2-220",390000),note:"Biến thể tham khảo cho Vario 160; kiểm tra đời, mâm và vị trí đĩa.",source:"Giá shop cố định"},
    {id:"rcb-e2-230",brand:"RCB",type:"fixed",size:"230",bike:"NMAX NVX",name:"RCB E2 Series Steel 230mm",code:"Dòng 01D0525Z",image:"assets/images/rcb-e2-steel.webp",price:configuredPrice("rcb-e2-230",420000),note:"Có ứng dụng NMAX/NVX; không chọn chỉ dựa trên đường kính.",source:"Giá shop cố định"},
    {id:"rcb-e2-256",brand:"RCB",type:"fixed",size:"256",bike:"Winner X RSX 150",name:"RCB E2 Series Steel 256mm",code:"Dòng 01D0525Z",image:"assets/images/rcb-e2-steel.webp",price:configuredPrice("rcb-e2-256",490000),note:"Có mã cho Winner X/RSX150; phải khớp tâm, lỗ và offset.",source:"Giá shop cố định"},
    {id:"rcb-e2-267",brand:"RCB",type:"fixed",size:"267",bike:"LC135 Y15ZR Y16ZR",name:"RCB E2 Series Steel 267mm",code:"Dòng 01D0525Z",image:"assets/images/rcb-e2-steel.webp",price:configuredPrice("rcb-e2-267",590000),note:"Đường kính 267mm, có nhiều cấu hình lỗ bắt theo xe.",source:"Giá shop cố định"},
    {id:"rcb-e2plus-260",brand:"RCB",type:"floating",size:"260",bike:"NMAX NVX Vario 125 Vario 150 Click 150",name:"RCB E2+ Floating 260mm",code:"SKU theo ứng dụng",image:"assets/images/rcb-e2-plus-floating.webp",price:configuredPrice("rcb-e2plus-260",1290000),note:"Dòng floating 260mm cho một số cấu hình NMAX/NVX/Vario/Click.",source:"Giá shop cố định"},
    {id:"rcb-e2plus-267-4",brand:"RCB",type:"floating",size:"267",bike:"LC135 125ZR",name:"RCB E2+ Floating 267mm · 4 lỗ",code:"01D0520",image:"assets/images/rcb-e2-plus-floating.webp",price:configuredPrice("rcb-e2plus-267-4",1390000),note:"Bản bốn lỗ cho LC135/125ZR; xác nhận phiên bản xe trước khi đặt.",source:"Giá shop cố định"},
    {id:"rcb-e2plus-267-5",brand:"RCB",type:"floating",size:"267",bike:"Y15ZR Y16ZR",name:"RCB E2+ Floating 267mm · 5 lỗ",code:"01D0533",image:"assets/images/rcb-e2-plus-floating.webp",price:configuredPrice("rcb-e2plus-267-5",1490000),note:"Bản năm lỗ cho Y15ZR/Y16ZR; kiểm tra cấu hình heo và pat.",source:"Giá shop cố định"},
    {id:"galfer-df532w",brand:"Galfer",type:"wave",size:"245",bike:"Exciter 150",name:"Galfer Wave DF532W 245mm",code:"DF532W · 5 lỗ · dày 4mm",image:"assets/images/galfer-floating-w-cw.webp",price:configuredPrice("galfer-df532w",2628000),note:"Đĩa trước Exciter 150; lòng trong 115mm theo thông số bán lẻ.",source:"Giá cố định trên website"},
    {id:"galfer-honda-256",brand:"Galfer",type:"wave",size:"256",bike:"Honda Winner Winner X",name:"Galfer Wave Honda 256mm",code:"Mã theo đời xe",image:"assets/images/galfer-floating-w-cw.webp",price:configuredPrice("galfer-honda-256",2750000),note:"Bản 256mm cho ứng dụng Honda; cần tra đúng mã xe và năm.",source:"Giá cố định trên website"},
    {id:"galfer-df071w",brand:"Galfer",type:"wave",size:"220",bike:"Honda Winner Winner X",name:"Galfer Wave DF071W sau 220mm",code:"DF071W · 4 lỗ · dày 4,2mm",image:"assets/images/galfer-floating-w-cw.webp",price:configuredPrice("galfer-df071w",2430000),note:"Đĩa sau Winner, lòng trong 105mm theo thông số bán lẻ.",source:"Giá cố định trên website"},
    {id:"galfer-fixed-v",brand:"Galfer",type:"fixed",size:"Nhiều size",bike:"Urban Custom",name:"Galfer Fixed Round (V)",code:"Tra mã theo hãng xe và năm",image:"assets/images/galfer-fixed-round-v.webp",price:configuredPrice("galfer-fixed-v",1890000),note:"Đĩa tròn fixed; chọn qua bộ tra cứu Galfer theo đúng ứng dụng.",source:"Giá shop cố định"},
    {id:"galfer-flv",brand:"Galfer",type:"floating",size:"Nhiều size",bike:"Urban Custom",name:"Galfer Floating Round (FLV)",code:"Tra mã theo hãng xe và năm",image:"assets/images/galfer-floating-round-flv.webp",price:configuredPrice("galfer-flv",2390000),note:"Đĩa tròn floating; cần khớp đường kính, offset và độ dày.",source:"Giá shop cố định"},
    {id:"galfer-cw",brand:"Galfer",type:"floating",size:"Nhiều size",bike:"Sport Urban",name:"Galfer Floating W Aluminium (CW)",code:"Tra mã theo ứng dụng",image:"assets/images/galfer-floating-w-cw.webp",price:configuredPrice("galfer-cw",2690000),note:"Dòng W floating tâm nhôm; chọn đúng mã cho xe, mâm và heo.",source:"Giá shop cố định"},
    {id:"x1r-winner-pair",brand:"X1R",type:"fixed",size:"256 + 220",bike:"Winner Winner X",name:"Cặp đĩa X1R Winner / Winner X",code:"Trước 256mm · sau 220mm",image:"assets/images/dia-phanh-xe-may.jpg",price:configuredPrice("x1r-winner-pair",550000),note:"Giá theo cặp; ảnh nhóm sản phẩm, shop xác nhận ngoại hình thực tế.",source:"Giá cố định trên website"},
    {id:"bum97-winner-256",brand:"BUM97",type:"fixed",size:"256",bike:"Winner X",name:"BUM97 Racing đĩa trước Winner X 256mm",code:"B97-2538",image:"assets/images/dia-phanh-xe-may.jpg",price:configuredPrice("bum97-winner-256",450000),note:"Mẫu đĩa trước 256mm; ảnh nhóm sản phẩm, xác nhận lô trước khi đặt.",source:"Giá cố định trên website"}
  ];
